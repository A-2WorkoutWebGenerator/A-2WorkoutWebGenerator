...
<main>
  ...
  <section id="6-diagrama-c4" typeof="scholarly:Materials">
    <h2>6. Diagrama C4</h2>
    <p>
      <em>Aici poți atașa sau descrie diagrama arhitecturii C4 a aplicației.</em>
    </p>
  </section>
  ...
  <section id="performance" typeof="scholarly:Results">
    <h2>Performance</h2>
    <ul>
      <li>homePerformance</li>
      <li>statisticsPerformance</li>
    </ul>
    <p>
      <em>(Adaugă valori sau capturi pentru performanța fiecărei pagini)</em>
    </p>
  </section>
</main>
